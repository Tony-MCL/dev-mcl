const no = {
  ...
  // ✅ NY: husk'et side (HusketPage.tsx)
  husket: {
    hero: {
      title: "husk'et",
  ...
  about: {
    ...
    principles: {
      ...
      bullets: {
        ...
        predictabilityBody:
          "design og teknikk må henge sammen – ellers bygges det ikke.",
        respect: "Respekt for tid og hode",
        respectBody:
          "alt som stjeler fokus uten å gi verdi regnes som en feil.",
        realWork: "Bygget for ekte arbeid",
        realWorkBody:
          "også når det skal printes, dokumenteres og etterprøves.",
      },
