const en = {
  ...
  home: {
    ...
    cards: {
      ...
      // ✅ NEW: husk'et (HomePage tile)
      husket: {
        title: "husk'et",
        body:
          "A photo alone isn’t a memory. husk'et is a calm way to save moments — with the context that makes you remember: a quick rating, a category, and a short note.",
        cta: "See husk'et →",
      },
  ...
  // ✅ NEW: husk'et page (HusketPage.tsx)
  husket: {
    hero: {
      title: "husk'et",
      tagline: "A photo alone isn’t a memory.",
      sub:
        "husk'et is a calm way to save moments — with the small extras that make you remember: a rating, a category, a note — and (optionally) a place.",
      contactCta: "Want a heads-up at launch? Get in touch →",
    },

    badge: "Coming soon",

    teaser: {
      title: "A small teaser",
      body:
        "A quick hint of what’s coming — no noise, no feed, no pressure.",
      alt: "husk'et teaser animation",
    },

    sections: {
      what: { title: "What husk'et is" },
      status: {
        title: "Status",
        body:
          "husk'et is under construction. This page is a landing page for early interest. Once the app is live, clear buttons will appear here for the App Store and Google Play.",
      },
    },
    ...
    cards: {
      moreThanPhoto: {
        ...
        body:
          "A photo often says little later. Add a feeling, a quick rating, or a short note — and find it again when it matters.",
      },
      calmControl: {
        title: "Calm and control",
        body:
          "Not a social feed. Not another noisy system. Just a private collection — designed to feel tidy, safe, and easy to use.",
      },
      everyday: {
        title: "Built for everyday life",
        body:
          "Low friction. Fast to save. Easy to find. Built for real moments — not for turning your life into an organizing project.",
      },
    },

    backCta: "← Back to Morning Coffee Labs",
  },
  ...
  about: {
    ...
    principles: {
      ...
      bullets: {
        ...
        predictabilityBody:
          "design and engineering must align — or it doesn’t ship.",
        respect: "Respect for time and headspace",
        respectBody:
          "anything that steals focus without adding value is a bug.",
